<template>
  <footer class="footer w-full relative z-50">
    <svg loading="lazy" class="footer-wave-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 100"
    ...
    <div class="footer-content">
      <footerColumn>
        <template #logo>
          <div class="footer-logo">
            <Logo imageSrc="/assets/images/LogoWhite.png" toName="home" addClass="footer-logo-link relative right-6" />
          </div>
        </template>
        ...
        <footerMenu titre="Voitures">
          <footerItem link="/neuf">Neuf</footerItem>
          <footerItem link="/occasion">Occasion</footerItem>
          <footerItem link="/location">Location</footerItem>
        </footerMenu>
      </footerColumn>
      ...
      <footerColumn addClass="float-right">
        <footerCallTo titre="Contactez-nous" description="Vous avez une question ? Nous avons la solution !">
          <router-link class="footer-call-to-action-button button bg-red-500 hover:bg-red-700" to="/contact"
            target="_self">
            Get in Touch
          </router-link>
        </footerCallTo>
        <footerCallTo titre="Appeler-nous">
      ...
      <footerSocialContainer>
        <footerSocialLink name="Linkedin" addClass="linkedin" link="">
        ...
        <footerSocialLink name="Twitter" addClass="twitter" link="">
        ...
        <footerSocialLink name="Youtube" addClass="youtube" link="">
          <svg class="footer-social-icon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
            <path class="footer-social-icon-path"
        ...
        <footerSocialLink name="Github" addClass="github" link="">
...
import footerItem from "@/Components/Footer/footer-item.vue";
import footerSocialLink from "@/Components/Footer/footer-social-link.vue";
