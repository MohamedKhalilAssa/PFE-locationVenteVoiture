<template>
  <section class="form bg-gray-200 flex justify-center items-center flex-col px-4">
    <form @submit.prevent="ajouterModele"
      ...
      <div class="mb-6">
        <label for="nom" class="inline-block text-lg mb-2 required">Nom du Modele</label>
        <input v-model="nomModele" id="nom" type="text" class="border border-gray-600 rounded p-2 w-full"
      ...
      <div class="mb-6">
        <label for="marque" class="inline-block text-lg mb-2 required">Marque</label>
        <select v-model="marqueVmodel" id="marque" class="border border-gray-600 rounded p-2 w-full">
